...
public class DBStatement {
	 ...
	 * 
	 * @param sql
	 * @param params          对应prepareStatement的参数封装
	 * @return
	 * @throws SQLException
	 * 
	 */
...
//		}
	 ...
	 * 执行更新语句（允许参数为空）
	 * 
	 * 范例： String sql = "insert into task(id,%s) values(seq_task.nextval,%s)"; hashmap.put("url",
	 * "http://www.taobao.com"); hashmap.put("updateTime", new java.util.Date()) // Oracle中为Date类型
	 * hashmap.put("pageType", maybe_null); db.updateWithNullableParam(sql, hashmap); // 要求为Map<String, Object>类型
	 * 
	 */
